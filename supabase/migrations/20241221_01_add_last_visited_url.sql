...
-- Create an index on last_visited_url for faster queries
CREATE INDEX IF NOT EXISTS idx_login_history_last_visited_url 
ON public.login_history(last_visited_url);
